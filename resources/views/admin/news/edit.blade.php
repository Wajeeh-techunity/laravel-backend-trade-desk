...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form role="form" action="{{route('update.news')}}" method="post" enctype="multipart/form-data" style="width: 100%">
                    @csrf
                            ...
                            <div class="card card-outline card-info">
                                ...
                                <div class="card-body pad">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required value="{{$news->title??''}}" name="title" placeholder="Enter News Title">
                                    </div>

                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Slug</label>
                                        <input type="text" class="form-control" value="{{$news->slug??''}}" name="slug" placeholder="Enter News Slug">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="textarea" name="short_description" placeholder="Place some text here"
                                                  style="width: 100%;font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$news->short_description??''}}</textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="textarea" name="description" placeholder="Place some text here"
                                                  style="width: 100%; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$news->description??''}}</textarea>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control" value="{{$news->image??''}}" name="image" id="imgfield" placeholder="Click To Choose\Upload Image">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                    <input type="text" name="publish_date" value="{{date('m/d/Y', strtotime($news->publish_date))}}" class="form-control datetimepicker-input" data-target="#reservationdate"/>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{$news->mata_title??''}}" name="mata_title" class="form-control" placeholder="Enter Meta Title">
                                            </div>
                                            <div class="form-group">
                                                <label>Meta Keywords</label>
                                                <textarea name="mata_keywords" placeholder="Place Meta Keywords"
                                                          style="width: 100%; height: 50px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$news->mata_keywords??''}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Meta Description</label>
                                                <textarea name="meta_description"  placeholder="Place Meta Description"
                                                          style="width: 100%; height: 50px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$news->meta_description??''}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
